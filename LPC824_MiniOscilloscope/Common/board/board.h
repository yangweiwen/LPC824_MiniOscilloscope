...
#ifdef  _BOARD_C_
static const uint8_t ledBits[BOARD_LED_CNT] = {15, 16, 17};
static const uint8_t cs_keyBits[BOARD_KEY_CNT] = {12, 13};
static const uint8_t cs_keyIoConNdce[BOARD_KEY_CNT] = {IOCON_PIO12, IOCON_PIO13};
#endif
